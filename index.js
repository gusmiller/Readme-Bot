...
function writeToFile() {
    ...
    CommonSection("contribution", "Contributing ", builder.contributiondata[0].data) // Build the application usage section
        ...
        .then((answer) => {
            if (answer.contributions == true) {
                if (answer.loremcontribution === "Lorem Ipsum") {
                    ...
                    builder.projectdescription = contribution.paragraphdata[0].data;
                }
...
function BuildTableContent() {
    ...
    if (builder.tablecontents == true) {
        ...
        if (builder.contributiondata.length > 0) {
